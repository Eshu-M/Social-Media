...
import { useDeleteSavedPost, useGetCurrentUser, useLikPost, useSavePost } from "@/lib/react-query/queriesAndMutations";
...
const PostStats = ({post , userId}:PostStatsProps) => {
    ...
    const {mutate:likePost}=useLikPost()
